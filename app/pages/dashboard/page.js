...
export default function EnhancedDashboard() {
  ...
  const calculateSensitivityAnalysis = () => {
    ...
    const baseIRR = portfolioMetrics.averageIRR || 12; // Base case IRR
    
    // Define sensitivity scenarios
    const scenarios = [
      { parameter: 'Electricity Price', change: '+10%', impact: baseIRR * 1.18 - baseIRR },
      { parameter: 'Electricity Price', change: '-10%', impact: baseIRR * 0.82 - baseIRR },
      { parameter: 'Capacity Factor', change: '+10%', impact: baseIRR * 1.15 - baseIRR },
      { parameter: 'Capacity Factor', change: '-10%', impact: baseIRR * 0.85 - baseIRR },
      { parameter: 'CAPEX', change: '+10%', impact: baseIRR * 0.88 - baseIRR },
      { parameter: 'CAPEX', change: '-10%', impact: baseIRR * 1.12 - baseIRR },
      { parameter: 'OPEX', change: '+10%', impact: baseIRR * 0.95 - baseIRR },
      { parameter: 'OPEX', change: '-10%', impact: baseIRR * 1.05 - baseIRR },
      { parameter: 'Contract Price', change: '+10%', impact: baseIRR * 1.12 - baseIRR },
      { parameter: 'Contract Price', change: '-10%', impact: baseIRR * 0.88 - baseIRR },
      { parameter: 'Interest Rate', change: '+1pp', impact: baseIRR * 0.92 - baseIRR },
      { parameter: 'Interest Rate', change: '-1pp', impact: baseIRR * 1.08 - baseIRR }
    ];
    ...
    const tornadoData = Object.entries(groupedScenarios)
      .map(([parameter, paramScenarios]) => {
        const maxAbsImpact = Math.max(...paramScenarios.map(s => Math.abs(s.impact)));
    ...
    <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow p-6 border">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">
                ${portfolioMetrics.totalRevenue.toFixed(1)}M
              </p>
        ...
        <div className="bg-white rounded-lg shadow p-6 border">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">
                {portfolioMetrics.contractedPercentage.toFixed(0)}%
              </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow border p-6">
          <h3 className="text-lg font-semibold mb-4">Revenue Projections (10-Year)</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-medium text-green-900">Manage Assets</p>
                  <p className="text-sm text-green-700">Add or modify portfolio assets</p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-medium text-blue-900">Revenue Analysis</p>
                  <p className="text-sm text-blue-700">Detailed revenue modeling</p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-medium text-purple-900">Project Finance</p>
                  <p className="text-sm text-purple-700">IRR and financing analysis</p>
                </div>
              </div>
            </a>
          </div>
      ...
      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
        <div className="flex items-center justify-between">
          ...
          <div className="text-green-600 text-sm">
            {Object.keys(assets).length} assets • {portfolioMetrics.totalCapacity.toFixed(1)} MW • 
            ${portfolioMetrics.totalCapex.toFixed(1)}M CAPEX
          </div>
        </div>
        <div className="mt-2 text-sm text-green-700">
          Real-time data integration with revenue calculations, contract analysis, and sensitivity modeling. 
          IRR tornado plot shows key value drivers and risk factors.
        </div>
      </div>
    </div>
  );
