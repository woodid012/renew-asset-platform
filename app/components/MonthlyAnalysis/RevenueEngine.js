...
export const calculateMonthlyGeneration = (asset, year, month, assetStartYear, constants) => {
...
export const calculateMonthlyStorageThroughput = (asset, year, month, assetStartYear, constants) => {
...
export const calculateMonthlyAssetRevenue = (asset, year, month, assetStartYear, constants, getMerchantPrice, scenario = 'base') => {
  ...
  if (asset.type === 'storage') {
    ...
    const throughputData = calculateMonthlyStorageThroughput(asset, year, month, assetStartYear, constants);
    ...
    const generationData = calculateMonthlyGeneration(asset, year, month, assetStartYear, constants);
